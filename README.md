...
The DISARM 2.0 Assessments Framework is a beta version of one component of the future DISARM Red Framework which complements the DISARM 2.0 Oservations Framework and Playbooks (TBD). The Assessments Framework allows analysts to make Assessments based on their Observations, such as the intent of the actor, the actual impact of a campaign, the capabilities employed by the campaign, and the threat actor behind the campaign.
