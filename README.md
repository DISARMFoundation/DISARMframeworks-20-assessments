# DISARM 2.0 Assessments Framework
...
The DISARM 2.0 Assessments Framework is a beta version of one component of the future DISARM Red Framework which complements the DISARM 2.0 Oservations Framework and Playbooks (TBD). The Navigator can be accessed here **[DISARM 2.0 Assessments Framework](https://disarmfoundation.github.io/disarm-navigator-mv/)**. Choose "Create New Layer" then "DISARM v2.0 Assessments. The Assessments Framework allows analysts to make Assessments based on their Observations, such as the intent of the actor, the actual impact of a campaign, the capabilities employed by the campaign, and the threat actor behind the campaign.

The Assessments Framework is organized into Impacts (the columns), which can be either threat actor goals or actual consequences, and Techniques and Sub-Techniques (the rows), which describe how the threat actor attempts to achieve the desired Impacts. Thus the DISARM 2.0 Assessments Framework is conceptually similar to the DISARM 1.x Red Framework except that Tactics have been replaced by Impacts, Impacts can be intended or unintended, and there are significantly fewer Techniques in the DISARM 2.0 Assessments Framework than in the DISARM 1.x Red Framework, as many of DISARM 1.x's Techniques have been converted into Observations.  

The idea behind DISARM 2.0 is to empower analysts to make the case for impactful defender actions which will counter FIMI. This involves collecting and characterizing evidence in terms of observations, grouping these observations, making inferences upon those observations, fusing these observations with other intelligence, and in that way building up assessments of who did what to whom, when, where, why, and how, in a way that makes a compelling case for an intervention. To avoid infringements of free speech, interventions beyond reporting on FIMI and educating targeted populations are not advised unless there is a clear violation of law, regulation, or terms of service. DISARM 2.0 helps analysts to document such violations and make the case for such interventions where appropriate.   
